                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="position-relative form-group">
                            ...
                            <div v-if="formErrors['feature_name']" class="errormsg alert alert-danger mt-1">
                              @{{ formErrors['feature_name'][0] }}
                            </div>
                        </div>
                    </div>
    ...
    new Vue({
        ...
        methods: {
            submitForm: function (e) {
                ...
                if($("#id").val() > 0){
                  var action = "{{ route('mainfeatures.update',0) }}";
                  var put = form.querySelector('input[name="_method"]').value;
                }else{
                  var action = "{{ route('mainfeatures.store') }}";
                  var put = '';
                }
                ...
                datas.append("feature_name", $("#feature_name").val());
