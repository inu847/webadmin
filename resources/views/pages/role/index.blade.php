                                ...
                                <tbody>
                                    @foreach ($roles as $key => $role)
                                        <tr>
                                            <td>{{ $key+1 }}</td>
                                            <td>{{ $role->name }}</td>
                                            <!-- <td>{{ optional($role->user)->name }}</td> -->
                                            <td>
                                                <a href="javascript:void(0)" data-id="{{ $role->id }}" class="detaillink btn btn-shadow btn-primary">Manage Menu</a>
                                                <a href="javascript:void(0)" data-id="{{ $role->id }}" class="editlink btn btn-shadow btn-info">Edit</a>
                                                <a href="javascript:void(0)" data-id="{{ $role->id }}" class="deletelink btn btn-shadow btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
