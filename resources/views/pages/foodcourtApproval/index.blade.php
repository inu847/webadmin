    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{ route('request-catalog.index') }}" class="btn-shadow btn btn-info btn-sm"><i class="icon lnr-sync"></i> Refresh</a>
            </div>
        </div>
    </div>
                                    ...
                                    @foreach ($foodcourts as $key => $foodcourt)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="javascript:void(0)" data-id="{{ $foodcourt->id }}" class="editlink btn btn-shadow btn-info">Approve</a>
            ...
            methods: {
                showForm: function (action, id = null) {
                    ...
                    if (action == "create") {
                        ...
                        $.ajax({
                            url: "{{ url('/request-catalog/create/') }}", 
                            type: "GET", 
                        })
                        .done(function(data) {
                        ...
                        axios
                            .get("{{ url('/request-catalog') }}" +"/" + id +"/edit"  )
                            .then((response) => {
                ...
                confirmDialog: function (id) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            preloadContent();
                            axios.delete("{{ url('/request-catalog') }}" + "/" + id)
                                .then((response) => {
                ...
                confirmDialog2: function (id) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            preloadContent();
                            axios.get("{{ url('/request-catalog') }}" + "/" + id +"/edit")
                                .then((response) => {
                                    var notif = response.data;
                                    var getstatus = notif.status;
                                    console.log();
