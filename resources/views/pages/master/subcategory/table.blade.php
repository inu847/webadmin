                            ...
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left mr-3">
                                    <div class="widget-content-left">
                                        <a href="javascript:void(0)" data-featherlight="{{ str_replace('scaneat.id', 'scaneat.id/liatmenu.id', myFunction::getProtocol()).$value['subcategory_image'].'?'.time() }}">
                                            <img width="40" class="rounded" src="{{ strpos($value['subcategory_image'], 'amazonaws.com') !== false ? $value['subcategory_image'] : str_replace('scaneat.id', 'scaneat.id/liatmenu.id', myFunction::getProtocol()).$value['subcategory_image'].'?'.time() }}" alt="" />
                                        </a>
                                    </div>
                                </div>
