    ...
    <div class='card'>
        <div class='card-body'>
            ...
            <div class='form-group'>
                ...
                <input type='email' class='form-control' value="" name='email' id='email' autocomplete="off" required>
            </div>
            <div class='form-group'>
            ...
            <div class='form-group'>
                ...
                <input type='text' class='form-control' value="" name='password_edit' id='password_edit'>
            </div>
            <div class='form-group'>
                <label for='password_edit'>Password Edit Timeout (in second)</label>
                <input type='number' class='form-control' value="" name='password_edit_timeout' id='password_edit_timeout'>
            ...
            <div class='form-group'>
                ...
                <input type='text' class='form-control' value="" name='phone' id='phone' required>
            </div>
            @if(!$affiliate)
            <div class='form-group'>
                <label for='number_catalog'>Number Catalog</label>
                <input type='number' class='form-control' value="" name='number_catalog' id='number_catalog' required>
            </div>
            @endif
            <div class='form-group'>
