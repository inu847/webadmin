                ...
                <form id="myForm" method="POST">
                    ...
                    <div class="card-header {{ (Session::get('catalogsession')=='All')?'d-none':'' }}">
                        <ul class="nav nav-justified">
                            ...
                            <li class="nav-item"><a data-toggle="tab" href="#tab-eg7-1" class="nav-link">Transaction Period</a></li>
                            <li class="nav-item"><a data-toggle="tab" href="#tab-eg7-2" class="nav-link">Item Sold</a></li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane {{ (Session::get('catalogsession')=='All')?'d-none':'active' }}" id="tab-eg7-0" role="tabpanel">
                                            ...
                                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-right" nowrap>Sold</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <canvas id="barChartViewed" style="min-height:230px"></canvas>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                        <th nowrap>Product Name</th>
                                                        <th class="text-right" nowrap>Viewed</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @foreach($sorted_viewed as $key => $value)
                                                    <tr>
                                                        <td nowrap>{{ $key }}</td>
                                                        <td class="text-right" nowrap>{{ $value }}</td>
                                                    </tr>
                            ...
                            <div class="tab-pane {{ (Session::get('catalogsession')=='All')?'active':'' }}" id="tab-eg7-1" role="tabpanel">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a data-toggle="tab" href="#tab-summary" class="nav-link {{ (Session::get('catalogsession')=='All')?'active':'d-none' }}">Summary</a></li>
                                    <li class="nav-item"><a data-toggle="tab" href="#tab-month" class="nav-link {{ (Session::get('catalogsession')=='All')?'':'active' }}">Month</a></li>
                                    <li class="nav-item"><a data-toggle="tab" href="#tab-day" class="nav-link">Day</a></li>
                                </ul>
                                <div class="tab-content">
                                            ...
                                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center" nowrap>{{ number_format(getData::getCountTransactionDay($getDay['created_at'])) }}</td>
                                    ...
                                    <div class="tab-pane {{ (Session::get('catalogsession')=='All')?'':'active' }}" id="tab-month" role="tabpanel">
                                        <div class="table-responsive">
                                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center" nowrap>{{ number_format(getData::getCountTransactionMonth($month,$year)) }}</td>
                                    ...
                                    <div class="tab-pane {{ (Session::get('catalogsession')=='All')?'active':'d-none' }}" id="tab-summary" role="tabpanel">
                                        <div class="table-responsive">
                                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td nowrap>{{ $value }}</td>
                                                        <td class="text-center" nowrap>{{ isset($summary[$key]) ? number_format(array_sum($summary[$key]['total'])) : 0 }}</td>
                                                        <td class="text-right" nowrap>{{ isset($summary[$key]) ? number_format(array_sum($summary[$key]['payment'])) : 0 }}</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tbody>
                                                @php
                                                    $temp_date = '';
                                                @endphp
                                                @foreach($itemDay as $itemDay)
                                                @php
                                                    $date = Date::myDate($itemDay['created_at']);
                                                @endphp
                                                <tr>
                                                    <td nowrap>{{ $date == $temp_date ? '' : $date }}</td>
                                                    <td nowrap>{{ $itemDay['items_name'] }}</td>
                                                    <td class="text-center" nowrap>{{ getData::getCountItemDay($itemDay['item_id'],$itemDay['created_at']) }}</td>
                                                </tr>
                                                @php
                                                    $temp_date = $date;
                                                @endphp
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tbody>
                                                @php
                                                    $temp_date = '';
                                                @endphp
                                                @foreach($itemMonth as $itemMonth)
                                                @php
                                                    $date = $itemMonth['created_at'];
                                                    $month = explode("-",$date)[1];
                                                    $year = explode("-",$date)[0];
                                                ...
                                                <tr>
                                                    <td nowrap>{{ $date == $temp_date ? '' : $date }}</td>
                                                    <td nowrap>{{ $itemMonth['items_name'] }}</td>
                                                    <td class="text-center" nowrap>{{ getData::getCountItemMonth($itemMonth['item_id'],$month,$year) }}</td>
                                                </tr>
                                                @php
                                                    $temp_date = $date;
                                                @endphp
...
<input type="hidden" id="viewed_data" value="{{ $viewed['data'] }}">
<input type="hidden" id="viewed_label" value="{{ $viewed['label'] }}">
                ...
                datasets: [
                    {
                        ...
                        data                : $('#viewed_data').val().split(",")
                    },
                ]
            }

            var barChartCanvas2 = $('#barChartViewed').get(0).getContext('2d')
