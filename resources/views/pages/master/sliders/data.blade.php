    ...
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <div class="page-title-icon">
                <i class="lnr-picture icon-gradient bg-ripe-malin"> </i>
            </div>
            <div>
                {{ $maintitle }}
        ...
        <div class="page-title-actions">
            <a href="{{ route('sliders.index') }}" class="btn-shadow btn btn-info btn-sm"><i class="icon lnr-sync"></i> Refresh</a>
        </div>
    </div>
</div>
...
@section('modal')
    @include('pages.master.sliders.form')
@endsection
...
@section('customjs')
            ...
            methods: {
                    ...
                    if (action == "create") {
                        ...
                        axios
                            ...
                            .then((response) => {
                                ...
                                $("#modalForm").modal("show");
                                $("#id").val(data.id);
                                $("#sliders_image").val(data.sliders_image);
                                $("#sliders_title").val(data.sliders_title);
                                afterpreloader();
                            })
                ...
                confirmDialog: function (id) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            preloadContent();
                            axios.get("{{ url('/sliders/delete') }}" +'/'+ id)
                                .then((response) => {
                                    let self = this;
    ...
    <script type="text/javascript">
        ...
        function loadView(page = null) {
            preloadContent();
            if (page == null) {
                var url = "{{ url('/sliders/data') }}";
            } else {
                var url = "{{ url('/sliders') }}" + "/" + page;
            }
            var obj = new Object();
