    ...
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            <div class="page-title-icon">
                <i class="lnr-star-half icon-gradient bg-ripe-malin"> </i>
            </div>
            <div>
                {{ $maintitle }}
        ...
        <div class="page-title-actions">
            <a href="{{ route('mainfeatures.index') }}" class="btn-shadow btn btn-info btn-sm"><i class="icon lnr-sync"></i> Refresh</a>
        </div>
    </div>
</div>
...
@section('modal')
    @include('pages.master.mainfeatures.form')
@endsection
...
@section('customjs')
            ...
            methods: {
                ...
                confirmDialog: function (id) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            preloadContent();
                            axios.get("{{ url('/mainfeatures/delete') }}" +'/'+ id)
                                .then((response) => {
                                    let self = this;
    ...
    <script type="text/javascript">
        ...
        function loadView(page = null) {
            preloadContent();
            if (page == null) {
                var url = "{{ url('/mainfeatures/data') }}";
            } else {
                var url = "{{ url('/mainfeatures') }}" + "/" + page;
            }
            var obj = new Object();
