                ...
                <div class="modal-content">
                    ...
                    <div id="modalContent" class="modal-body">
                        <div class="position-relative form-group">
                            <label>Ingredient Name <sup class="text-danger">* (Required)</sup></label>
                        ...
                        <div class="position-relative form-group">
                            <label>Satuan</label>
                            <select id="item_unit" class="custom-select">
    ...
    new Vue({
        ...
        methods: {
            submitForm: function (e) {
                ...
                if($("#id").val() > 0){
                  var action = "{{ route('ingredient.update',0) }}";
                  var put = form.querySelector('input[name="_method"]').value;
                }else{
                  var action = "{{ route('ingredient.store') }}";
                  var put = '';
                }
