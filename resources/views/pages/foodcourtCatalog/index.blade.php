                            ...
                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach ($catalogs as $key => $catalog)
                                        <tr>
                                            <td><img width="100px" src="{{ $catalog->catalog_logo }}" alt=""></td>
                                            <td>{{ $catalog->user->name }}</td>
                                            <td>{{ $catalog->catalog->catalog_username }}</td>
                                            <td>
                                                {{-- <a href="javascript:void(0)" data-id="{{ $catalog->id }}" class="detaillink btn btn-shadow btn-primary">Detail</a> --}}
                                                <a href="javascript:void(0)" data-id="{{ $catalog->id }}" class="editlink btn btn-shadow btn-info">Edit</a>
                                                <a href="javascript:void(0)" data-id="{{ $catalog->id }}" class="deletelink btn btn-shadow btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
