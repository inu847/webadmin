...
<div class="app-page-title">
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <a href="{{ route('user_complaint.index') }}" class="btn-shadow btn btn-info btn-sm"><i class="icon lnr-sync"></i> Refresh</a>
        </div>
    </div>
</div>
...
@section('modal')
    @include('pages.master.user_complaint.form')
@endsection
...
@section('customjs')
            ...
            methods: {
                ...
                confirmDialog: function (id) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            preloadContent();
                            axios.get("{{ url('/user_complaint/delete') }}" +'/'+ id)
                                .then((response) => {
                                    let self = this;
    ...
    <script type="text/javascript">
        ...
        function loadView(page = null) {
            preloadContent();
            if (page == null) {
                var url = "{{ url('/user_complaint/data') }}";
            } else {
                var url = "{{ url('/user_complaint') }}" + "/" + page;
            }
            var obj = new Object();
        ...
        function loadGallery(id){
            ...
            $.ajax({
                url: "{{ url('/user_complaint/gallery') }}" +'/'+ id,
                type: 'GET',
                dataType: 'html',
            })
            .done(function(data) {
