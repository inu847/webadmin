...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>
                Manage {{ (Session::get('catalogsession')=='All')?'Warehouse':getData::getCatalogSession('catalog_title') }} Material Stock
        ...
        <div class="page-title-actions">
            <a href="{{ route('material.index') }}" class="btn-shadow btn btn-info btn-sm"><i class="icon lnr-sync"></i> Refresh</a>
        </div>
    </div>
</div>
...
{{-- @section('modal')
    @include('pages.master.material.form')
@endsection --}}
...
@section('customjs')
            ...
            methods: {
                ...
                confirmDialog: function (id) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            preloadContent();
                            axios.get("{{ url('/material/delete') }}" + "/" + id)
                                .then((response) => {
                                    let self = this;
    ...
    <script type="text/javascript">
        ...
        function loadView(page = null) {
            preloadContent();
            if (page == null) {
                var url = "{{ url('/material/data') }}";
            } else {
                var url = "{{ url('/material') }}" + "/" + page;
            }
            var obj = new Object();
