...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>
                Manage {{ (Session::get('catalogsession')=='All')?'Warehouse':getData::getCatalogSession('catalog_title') }} Item Stock
        ...
        <div class="page-title-actions">
            <a href="{{ route('stock.index') }}" class="btn-shadow btn btn-info btn-sm"><i class="icon lnr-sync"></i> Refresh</a>
        </div>
    </div>
</div>
...
@section('modal')
    @include('pages.master.stock.form')
@endsection
...
@section('customjs')
    ...
    <script type="text/javascript">
        ...
        function loadView(page = null) {
            preloadContent();
            if (page == null) {
                var url = "{{ url('/stock/data') }}";
            } else {
                var url = "{{ url('/stock') }}" + "/" + page;
            }
            var obj = new Object();
