...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>
                Manage Serving {{ $item['items_name'] }}
        ...
        <div class="page-title-actions">
            <a href="{{ route('addons.index') }}" class="btn-shadow btn btn-info btn-sm"><i class="icon lnr-arrow-left"></i> Back</a>
        </div>
    </div>
</div>
...
<div id="indexVue">
    <div class="tabs-animation">
        <div class="row">
            <div class="col-md-12">
                @if($detail->count() < 1)
                <div id="newServing" class="d-flex flex-wrap justify-content-between mb-2">
                    <div>
...
@section('modal')
@include('pages.master.addons.formserving')
@endsection 
        ...
        methods: {
            showForm: function (action, id = null) {
                ...
                if (action == "create") {
                    ...
                    axios
                        .get("{{ url('/addons/detailserving') }}" +'/'+ id)
                        .then((response) => {
            ...
            confirmDialog: function (item, addon) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        preloadContent();
                        axios.get("{{ url('/addons/delete/serving') }}" + "/" + item + "/" + addon)
                            .then((response) => {
                                let self = this;
...
<script type="text/javascript">
    ...
    function loadView(page = null) {
        preloadContent();
        if (page == null) {
            var url = "{{ url('/addons/serving') }}"+"/{{ $item['id'] }}";
        } else {
            var url = "{{ url('/addons/serving') }}" + "/" + page;
        }
        var obj = new Object();
